...
Returns:
{
    "user": {
        ...
        "username": "Bob3",
        "authentication_token": "VemZ6NH3xLbDRg3YFW-P"
    }
}
...
Returns:
{
    "user": {
        ...
        "username": "Apple1",
        "authentication_token": "8Q8BdF-LwGwktjefGkuU"
    }
}
...
Route: https://cryptic-mesa-8497.herokuapp.com/users/:id
 Example: http://localhost:3000/users/23
Request: PUT
Form Data: user[gender], user[interests]
 Example: user[gender] = "male"
          user[interests] = "singing, dancing, programming"
...
Returns:
{
    "user": {
        ...
        "username": "Bob2",
        "authentication_token": "Y7EC3-yPunpUW667Pa-3"
    },
    "gender": "male",
    "interests": [
        {
    ...
    "events": [
        {
            ...
            "longitude": -75.922749,
            "id": 5,
            "venue": "116 MLK Junior Drive NW, Atlanta, GA-30309",
            "start_time": null,
            "end_time": "2015-03-13T20:56:03.904Z",
            "wingman_gender": "male",
            "radius": null,
            "creator_id": null,
            "creator_gender": null,
        ...
        },
        {
            ...
            "venue": null,
            "start_time": null,
            "end_time": "2015-03-13T19:41:22.752Z",
            "wingman_gender": null,
            "radius": null,
            "creator_id": null,
            "creator_gender": null,
        ...
        },
        {
            ...
            "id": 12,
            "venue": "Peachtree",
            "start_time": "2015-03-15T20:36:01.428Z",
            "end_time": "2015-03-16T01:36:01.428Z",
            "wingman_gender": "male",
            "radius": null,
            "creator_id": 1,
            "creator_gender": null,
            "creator_name": null,
            "creator_interests": "dancing,programming,",
            "distance": 456.7819834619626,
            "creator_phone_number": null,
            "creator_age": null
        }
    ]
...
let options: [String:AnyObject] = [
           ...
           "method": "POST",
           "body": [
              "event": [ "venue": venue, "start_time": start_time,
              "end_time": end_time, "wingman_gender" : seeking_gender]
            ]
           ]
       ]
